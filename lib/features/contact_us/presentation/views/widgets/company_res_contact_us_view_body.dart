...
class CompanyResContactUsViewBody extends StatefulWidget {
  const CompanyResContactUsViewBody({super.key, required this.user});

  final UserDetailsEntity user;

  @override
  State<CompanyResContactUsViewBody> createState() =>
      _CompanyResContactUsViewBodyState();
}

class _CompanyResContactUsViewBodyState
    extends State<CompanyResContactUsViewBody> {
  @override
  void initState() {
    super.initState();
                      ...
                      if (state is ContactSuccess) {
                        ...
                        return TabBarView(
                          children: [
                            ...
                            CompanyResContactUsSection(messages: contacts),
                          ],
                        );
                      }
