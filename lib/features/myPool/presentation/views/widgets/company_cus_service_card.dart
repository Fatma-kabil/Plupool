...
class CompanyCusServiceCard extends StatelessWidget {
  const CompanyCusServiceCard({
    super.key,
    required this.item,
  });

  final PoolItemEntity item;

  @override
  Widget build(BuildContext context) {
    final status = mapApiStatus(item.status);
        ...
        child: Column(
          children: [
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          "${formatArabicDateOnly(item.bookingDate)} - ${formatTimeArabic3(item.bookingTime)}",
                          textDirection: TextDirection.rtl,
            ...
            Wrap(
              ...
              children: item.technicians.map((technician) {

                return SizedBox(
                  width: item.technicians.length == 1
                      ? double.infinity
