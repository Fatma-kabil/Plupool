...
import 'package:plupool/features/reports/presentation/views/widgets/report_section.dart';
...
class AdminReportViewBody extends StatelessWidget {
  const AdminReportViewBody({super.key});
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(child: TabWithCount(title: 'الشكاوي', count: 2)),
