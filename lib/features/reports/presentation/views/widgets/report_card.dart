...
import 'package:plupool/features/reports/presentation/views/widgets/report_card_header.dart';
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            /// ---- Header ----
            ReportCardHeader(status: status),
            SizedBox(height: SizeConfig.h(10)),

            ReportCardRow(title: "نوع الخدمة", value: "باقة شهرية"),
            SizedBox(height: SizeConfig.h(5)),
            ReportCardRow(title: "اسم العميل", value: "أحمد محمد"),
            SizedBox(height: SizeConfig.h(5)),
