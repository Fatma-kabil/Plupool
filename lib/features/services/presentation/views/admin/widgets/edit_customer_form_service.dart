...
class EditCustomerFormService extends StatefulWidget {
  const EditCustomerFormService({
    ...
    required this.companyResNameController,
    required this.onCompanyRepSelected,
  ...
  final Function(int? id, String name) onCompanyRepSelected;
        ...
        children: [
          ...
          CompanySearchField(
            ...
            onSelected: (UserEntity user) {
              ...
              widget.onCompanyRepSelected(user.id, user.fullName);
            },
          ),
