      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          child: Container(
            ...
            padding: EdgeInsets.symmetric(horizontal: SizeConfig.w(15),vertical: SizeConfig.h(12)),
            ...
            child: Row(
              children: [
                Icon(customerFooter[index]['icon'], color: customerFooter[index]['color'], size: SizeConfig.w(24)),
