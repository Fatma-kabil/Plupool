...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const CustomAppBar({super.key, this.onPressed, this.isSearch = false, this.onChanged});
  ...
  Size get preferredSize => Size.fromHeight(
    SizeConfig.isWideScreen ? SizeConfig.h(80) : SizeConfig.h(57),
  );
}
