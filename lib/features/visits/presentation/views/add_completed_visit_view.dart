...
class AddCompletedVisitView extends StatefulWidget {
  ...
  @override
  State<AddCompletedVisitView> createState() =>
      _AddCompletedVisitViewState();
}

class _AddCompletedVisitViewState
    extends State<AddCompletedVisitView> {
